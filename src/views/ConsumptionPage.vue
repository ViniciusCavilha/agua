    ...
    <ion-content :fullscreen="true">
      <AppShell title="Consumo" period-label="7 dias">
        <section class="summary-grid">
          <article v-for="item in consumptionStats" :key="item.label" class="stat-card">
        ...
        <section class="content-grid">
          <article class="usage-card">
            <div class="card-title">
              ...
              <span><ion-icon :icon="calendarOutline" /> Semana atual</span>
            </div>

            <div class="bar-chart" aria-label="Grafico semanal de consumo">
              <div v-for="bar in weeklyBars" :key="bar.day" class="bar-item">
          ...
          <article class="alert-card">
            ...
            <h2>Aguardando leituras</h2>
            <p>Assim que os medidores enviarem informacoes, os alertas e variacoes aparecem aqui.</p>
            <div class="health-row">
              <span>Saude da rede</span>
              <strong>0%</strong>
            </div>
          </article>
        </section>
